...
<div class="row g-3 mb-4">
    <div class="col-md-6">
        <div class="metric">
            <div class="label">Absences approuvées</div>
            <div class="value"><?= $approvedCount ?></div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="metric success">
            <div class="label">Absences en attente sur la période</div>
        ...
        <table class="table align-middle mb-0">
            ...
            <tbody>
                <?php foreach ($absences as $absence): ?>
                    <tr>
                        <td><?= esc($absence['prenom'] . ' ' . $absence['nom']) ?></td>
                ...
                <?php if (empty($absences)): ?>
                    <tr>
                        <td colspan="5" class="text-muted">Aucune absence enregistrée ce mois-ci.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
